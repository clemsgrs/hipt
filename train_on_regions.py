...
def main(cfg: DictConfig):
    ...
    train_dataset = StackedRegionsDataset(train_df, region_dir, cfg.region_size, cfg.region_fmt, cfg.label_name, cfg.label_mapping, M_max=cfg.M_max)
    tune_dataset = StackedRegionsDataset(tune_df, region_dir, cfg.region_size, cfg.region_fmt, cfg.label_name, cfg.label_mapping, M_max=cfg.M_max)
    test_dataset = StackedRegionsDataset(test_df, region_dir, cfg.region_size, cfg.region_fmt, cfg.label_name, cfg.label_mapping, M_max=cfg.M_max)
